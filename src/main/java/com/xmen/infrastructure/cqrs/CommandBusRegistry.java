...
/**
 * Command bus registry implementation
 *
...
@Component
@Primary
public class CommandBusRegistry implements CommandBus {

    private Map<Class, CommandHandler> handlers;

    public CommandBusRegistry(List<CommandHandler> commandHandlerImplementations) {
